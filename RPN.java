...
public class RPN{
    ...
    public static void main (String[] args) throws Exception{
        ...
        // Loop responsible for evaluating  the RPN expression
        for(Token t : tokens){
    ...
    // Function responsible for separating the input in tokens
    ...
    // Function Responsible to execute a binary operation between tokens of type NUM
